...
//     // Handle case: sometimes "Checking user..." requires extra click
//     await safeClick(this.signInBtn);
//     console.log('✅ Clicked Sign in button.');

//     // Optional retry if still on same page
//     await this.page.waitForTimeout(3000);
//     if (await this.signInBtn.isVisible()) {
//       console.log('⚠️ Still on login page, clicking Sign in again.');
//       await safeClick(this.signInBtn);
//     }
