// // tests/FMC_intro.spec.js
// const { test, expect } = require('@playwright/test');
// const { LoginPage } = require('../pages/LoginPage.js');

// /* -----------------------------------------------------------------------
//    Re‑usable safe‑click (auto‑retry + scroll + stable wait)
//    ----------------------------------------------------------------------- */
...
//     test.setTimeout(180_000);          // CI‑safe overall timeout

//     // ---- 1. Login ----------------------------------------------------
    

//     // wait for any post‑login URL (dashboard / deals / home)
...
//     // ---- 2. Helper to pick a filter checkbox ------------------------
//     await page.getByRole('link', { name: 'Today\'s Deals' }).click();
//   await page.getByRole('checkbox', { name: 'Clothing Accessories' }).check();
//   await page.getByRole('button', { name: 'Clear (39)' }).click();
//   await page.getByRole('link', { name: 'New' }).click();
//   await page.getByRole('checkbox', { name: 'Home Kitchen' }).check();
 
//   await page.getByRole('button', { name: 'Clear (14)' }).click();
//   await page.getByRole('link', { name: 'Kids' }).click();
//   await page.getByRole('checkbox', { name: 'Kid S Fashion' }).check();
//   await page.getByRole('button', { name: 'Clear (7)' }).click();
//   await page.getByRole('link', { name: 'Women' }).click();
//   await page.getByRole('checkbox', { name: 'Clothing Accessories' }).check();
//   await page.getByRole('button', { name: 'Clear (27)' }).click();
//   await page.getByRole('link', { name: 'Men', exact: true }).click();
//   await page.getByRole('checkbox', { name: 'Men S Fashion' }).check();
//     // ---- 7. Final screenshot (Jenkins artifact) --------------------
